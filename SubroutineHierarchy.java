...
public class SubroutineHierarchy extends JPanel {
	...
	private void drawWorld(Graphics2D g2) {
		...
		//
		//
		Bench2(g2,Color.BLUE);
		g2.translate(-2.5,5);
		g2.scale(0.8, 0.8);
		Bench2(g2,new Color(0x7851A9));
		g2.translate(6,3);
		g2.scale(0.8, 0.8);
		Bench2(g2,new Color(0x008000));
	} // end drawWorld()
	...
	private void rotatingOsmiokat(Graphics2D g2) { 
	...
	private void Bench(Graphics2D g2) { // (DELETE THIS EXAMPLE)
		AffineTransform saveTransform = g2.getTransform();  // (It might be necessary to save/restore transform and color)
		Color saveColor = g2.getColor();
		g2.setColor(Color.red);
	      g2.fill(new Rectangle2D.Double(-0.05,0,0.2,3));
		
	}

	private void Bench2(Graphics2D g2,Color kolor) { // (DELETE THIS EXAMPLE)
		
		g2.translate(1.4, -1.3);
		rotatingOsmiokat(g2); 
		g2.translate(-1.4, 1.3);
		
		g2.translate(-1.4, -0.4);
		rotatingOsmiokat(g2);
		g2.translate(1.4, 0.4);
		
		
		g2.translate(1.4, -1.35);
		g2.rotate(Math.PI/2.5);
		Bench(g2);
		g2.rotate(-Math.PI/2.5);
		g2.translate(-1.4, 1.35);
		g2.setColor( kolor );
	...
	public SubroutineHierarchy() {
		...
		osmiakat = new Path2D.Float();
	      osmiakat.moveTo(0.5F,1.2071F);
	      osmiakat.lineTo(1.2071F,0.5F);
	      osmiakat.lineTo(1.2071F,-0.5F);
	      osmiakat.lineTo(0.5F,-1.2071F);
	      osmiakat.lineTo(-0.5F,-1.2071F);
	      osmiakat.lineTo(-1.2071F,-0.5F);
	      osmiakat.lineTo(-1.2071F,0.5F);
	      osmiakat.lineTo(-0.5F,1.2071F);
